 ...
 * @author Christian
 */
public class ManejadorBilleteCien extends ManejadorBillete {

    protected EventListenerList listenerList = new EventListenerList();

    public ManejadorBilleteCien(int cantidad) {
        super(cantidad, 100);
    }
    ...
    protected void manejarRetiro(int restante, String acumulado) {
        ...
        if (cantidadBilletes > 0) {
            ...
            this.notificarBillete100(addBillete);
        }
        ...
        if (resto == 0) {
            System.out.println("Se concluyo en el Manejador billete de Cien");
            EventConcluido evt = new EventConcluido(true, acumulado, this);
            this.notificarBilleteConcluido100(evt);
        }
    }
    ...
    void notificarBillete100(EventAddBillete evt) {
    ...
    void notificarBilleteConcluido100(EventConcluido evt) {
        Object[] listeners = listenerList.getListenerList();
        for (int i = 0; i < listeners.length; i = i + 2) {
            if (listeners[i] == ComunicationListener.class) {
