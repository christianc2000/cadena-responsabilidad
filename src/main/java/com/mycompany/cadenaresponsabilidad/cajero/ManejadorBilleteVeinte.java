 ...
 * @author Christian
 */
public class ManejadorBilleteVeinte extends ManejadorBillete {

    protected EventListenerList listenerList = new EventListenerList();

    public ManejadorBilleteVeinte(int cantidad) {
        super(cantidad, 20);
    }
    ...
    protected void manejarRetiro(int restante, String acumulado) {
        ...
        if (cantidadBilletes > 0) {
            ...
            this.notificarBillete20(addBillete);
        }
        ...
        if (resto == 0) {
            System.out.println("Se concluyo en el Manejador billete de Veinte");
            EventConcluido evt = new EventConcluido(true, acumulado, this);
            this.notificarBilleteConcluido20(evt);
        }
    }
    ...
    void notificarBillete20(EventAddBillete evt) {
    ...
    void notificarBilleteConcluido20(EventConcluido evt) {
        Object[] listeners = listenerList.getListenerList();
        for (int i = 0; i < listeners.length; i = i + 2) {
            if (listeners[i] == ComunicationListener.class) {
